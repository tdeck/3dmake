''' Catch-all for Bambu-specific breakouts and shared logic '''
...
def vendor_is_bambu(printer_config_vendor: str) -> bool:
    # For now this is how 3DMake detects whether a printer
    # profile is a Bambu Labs printer that can support Bambu Connect
    # and Bambu LAN mode
    return 'bambu' in printer_config_vendor.lower()
